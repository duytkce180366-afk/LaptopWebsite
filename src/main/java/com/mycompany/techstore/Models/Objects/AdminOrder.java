...
public class AdminOrder {
    ...
    private String customerName,email,phone,addressInfo,paymentMethod,paymentStatus,orderStatus,note;
    ...
    public String getAddressInfo(){return addressInfo;} public void setAddressInfo(String v){addressInfo=v;}
    ...
    public BigDecimal getFinalTotal(){return totalAmount.add(shippingFee).subtract(discountAmount);}
    ...
    public List<OrderDetail> getDetails(){return details;} public void setDetails(List<OrderDetail> v){details=v;}
}
