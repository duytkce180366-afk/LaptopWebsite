...
public class ProductRepository extends DbClass {
    ...
    public boolean CreateProduct(int categoryId, int brandId, String sku, String productName,
    ...
    public boolean UpdateProduct(int productId, int categoryId, int brandId, String sku,
            String productName, String description, long price, int stock, String thumbnail,
            String status) {
        String sql = """
                UPDATE bs_Products
