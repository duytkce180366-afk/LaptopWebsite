...
public class AddressRepository extends DbClass {
    ...
    public boolean CreateAddress(int userId, String line1, String line2, String city, String state, String postal,
            String country, boolean isDefault) {
        boolean ok = false;

        String sql = """
                INSERT INTO bs_Addresses (user_id, line1, line2, city, state, postal_code, country, is_default, created_at, updated_at)
