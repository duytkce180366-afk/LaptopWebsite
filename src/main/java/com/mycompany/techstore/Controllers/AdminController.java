...
@WebServlet(
    name = "LegacyAdminController",
    urlPatterns = {"/admin/legacy"})
      ...
      case "product" -> {
        switch (request.getParameter("action")) {
          ...
          case "delete" -> {
            ...
            response.sendRedirect(request.getContextPath() + "/admin?target=product");
          }
    ...
    if ("product".equals(target)) {
      ...
      if ("create".equals(action)) {
        ...
        productService.createProduct(
            categoryId, brandId, sku, productName, description, price, stock, thumbnail, status);
