...
<link rel="stylesheet" href="<%= request.getContextPath()%>/css/styles.css?v=price-slider-2" />
<script defer src="<%= request.getContextPath()%>/js/theme.js"></script>
<script defer src="<%= request.getContextPath()%>/js/megaMenu.js"></script>
<script defer src="<%= request.getContextPath()%>/js/priceSlider.js?v=price-slider-2"></script>
