...
<link rel="stylesheet" href="<%= request.getContextPath()%>/css/styles.css?v=storefront-10" />
<script defer src="<%= request.getContextPath()%>/js/theme.js"></script>
<script defer src="<%= request.getContextPath()%>/js/megaMenu.js"></script>
<script defer src="<%= request.getContextPath()%>/js/priceSlider.js?v=price-slider-5"></script>
