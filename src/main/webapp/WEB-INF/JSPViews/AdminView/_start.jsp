...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/admin.css"></head><body>
<div class="admin-layout"><aside class="admin-sidebar">
    <a class="admin-brand" href="${pageContext.request.contextPath}/admin/dashboard">TechStore <span><c:out value="${backOfficeRole}"/></span></a>
    <nav><a href="${pageContext.request.contextPath}/admin/dashboard">Dashboard</a>
        <c:if test="${isAdmin}"><a href="${pageContext.request.contextPath}/admin/products">Products</a></c:if>
        ...
        <a href="${pageContext.request.contextPath}/admin/reports">Reports</a></nav>
    <div class="sidebar-bottom"><a href="${pageContext.request.contextPath}/home">View store</a><a href="${pageContext.request.contextPath}/auth?action=logout">Sign out</a></div>
</aside><main class="admin-main"><header class="admin-topbar"><div><small><c:out value="${backOfficeRole}"/> workspace</small><h1><c:out value="${pageTitle}"/></h1></div>
