...
class OrderStatusPolicyTest {
    @Test void acceptsRequiredWorkflow(){
    ...
    @Test void rejectsSkippedOrRepeatedStatus(){
        ...
        assertThrows(IllegalArgumentException.class,()->OrderStatusPolicy.requireValid("Pending","Delivered"));
    }
}
