...
class BackOfficeAuthorizationPolicyTest {
    @Test void staffCanPerformDailyOperations() {
    ...
    @Test void staffCannotManageProductsRolesOrReportData() {
    ...
    @Test void adminCanAccessAllBackOfficeOperations() {
        assertTrue(BackOfficeAuthorizationPolicy.canAccess("Admin", "POST", "/admin/users/role"));
        assertTrue(BackOfficeAuthorizationPolicy.canAccess("Admin", "POST", "/admin/products/deactivate"));
    }
}
